...
The Ethernet platform is designed to support a ZCU670 board for showcasing the XXV IP as a peripheral and PL based IEEE 1588 Precision Time Protocol (PTP) solution for PTP packet processing. It consists of XXV IP configured to support 25G and is interfaced to TX and RX channels of an MCDMA. 
